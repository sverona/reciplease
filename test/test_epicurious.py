...
class TestEpicurious:
    ...
    def test_instructions(self):
        ...
        """
        assert "Mix butter, cinnamon, and 1/2 cup brown sugar in a medium bowl until combined." in self.recipe.instructions["For the Filling and Assembly"]

    def test_time(self):
        """...properly parse the times into a dict.
        """
        expected = {"Active": "1 hour 10 minutes",
